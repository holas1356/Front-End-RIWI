...
const projects = ref<Project[]>([
  { title: "BGC eCommerce App", leader: "Eileen", team: [{ avatar: con1 }, { avatar: con2 }, { avatar: con3 }, { avatar: con4 }], progress: 78, icon: react },
  { title: "Falcon Logo Design", leader: "Owen", team: [{ avatar: con1 }, { avatar: con2 }], progress: 25, icon: support },
  { title: "Dashboard Design", leader: "Keith", team: [{ avatar: con5 }, { avatar: con1 }, { avatar: con2 }, { avatar: con3 }], progress: 62, icon: ui },
  { title: "Foodista mobile app", leader: "Merline", team: [{ avatar: con1 }, { avatar: con2 }, { avatar: con3 }, { avatar: con4 }], progress: 8, icon: vue },
  { title: "Dojo Email App", leader: "Harmonia", team: [{ avatar: con1 }, { avatar: con2 }, { avatar: con3 }, { avatar: con4 }], progress: 51, icon: twiter },
  { title: "BGC eCommerce App", leader: "Eileen", team: [{ avatar: con1 }, { avatar: con2 }, { avatar: con3 }, { avatar: con4 }], progress: 78, icon: react },
  { title: "Falcon Logo Design", leader: "Owen", team: [{ avatar: con1 }, { avatar: con2 }], progress: 25, icon: support },
  { title: "Dashboard Design", leader: "Keith", team: [{ avatar: con5 }, { avatar: con1 }, { avatar: con2 }, { avatar: con3 }], progress: 62, icon: ui },
  { title: "Foodista mobile app", leader: "Merline", team: [{ avatar: con1 }, { avatar: con2 }, { avatar: con3 }, { avatar: con4 }], progress: 8, icon: vue },
